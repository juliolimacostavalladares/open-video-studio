...
export const BrandKitSchema = z.object({
  ...
  secondaryColor: z.string().regex(/^#[0-9A-F]{6}$/i, "Must be a valid hex color code"),
  accentColor: z.string().regex(/^#[0-9A-F]{6}$/i, "Must be a valid hex color code"),
  ...
  subtitleStyle: z.object({
    ...
    shadowColor: z.string().regex(/^#[0-9A-F]{6}$/i).default("#000000"),
