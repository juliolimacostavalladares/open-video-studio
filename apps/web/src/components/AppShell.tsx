  ...
  return (
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <Link className="button button-primary sidebar-create" href="/projects/new">
          <PlusIcon />
          Novo vídeo
        </Link>
        ...
        <div className="sidebar-footer">
          <div className="plan-card">
            ...
            <div className="service-status"><span /> Serviços ativos</div>
          </div>
          <div className="user-row">
            <span className="avatar">OV</span>
            <span><strong>Operador</strong><small>Workspace principal</small></span>
          </div>
        </div>
      </aside>
